...
<head>
    ...
    <meta name="description"
        content="Mua sắm trực tuyến trên Shopee với đa dạng sản phẩm từ thời trang, điện tử đến gia dụng.">
    ...
    <header class="bg-[#ee4d2d] text-white text-sm">
        <div class="max-w-screen-xl mx-auto flex justify-between items-center px-4 py-2">
            ...
            <div class="flex items-center space-x-3">
                <a href="./login-signup/login-signup.html" aria-label="Đăng nhập tài khoản"
                    style="text-decoration: none;" class="hover:underline">Đăng Nhập</a>
            </div>
        </div>
    </header>
        ...
        <div class="max-w-screen-xl mx-auto px-4 py-4">
            <div class="flex items-center gap-4 flex-wrap">
                ...
                <div class="flex-1">
                    <div class="relative w-full h-10">
                        <input type="text" placeholder="Tìm sản phẩm, thương hiệu và tên shop..."
                            class="w-full h-full border border-gray-300 rounded-sm pl-4 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                            aria-label="Tìm kiếm sản phẩm" />
                        <button
                            class="absolute right-0 top-0 h-full px-4 bg-[#ee4d2d] text-white rounded-r-sm hover:bg-gray-100 flex items-center justify-center transition"
                            aria-label="Tìm kiếm">
                ...
                <a href="cart.html" class="text-white text-2xl relative" aria-label="Giỏ hàng">
                    ...
                    <span
                        class="absolute -top-2 -right-2 text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full border border-white bg-[#ee4d2d]"
                ...
                <div class="col-lg-8">
                    <div id="shopeeBanner" class="carousel slide h-100" data-bs-ride="carousel">
                        ...
                        <div class="carousel-indicators">
                            ...
                            <button type="button" data-bs-target="#shopeeBanner" data-bs-slide-to="1"
                                aria-label="Slide 2"></button>
                            <button type="button" data-bs-target="#shopeeBanner" data-bs-slide-to="2"
                                aria-label="Slide 3"></button>
                            <button type="button" data-bs-target="#shopeeBanner" data-bs-slide-to="3"
                                aria-label="Slide 4"></button>
                            <button type="button" data-bs-target="#shopeeBanner" data-bs-slide-to="4"
                                aria-label="Slide 5"></button>
                            <button type="button" data-bs-target="#shopeeBanner" data-bs-slide-to="5"
                                aria-label="Slide 6"></button>
                            <button type="button" data-bs-target="#shopeeBanner" data-bs-slide-to="6"
                                aria-label="Slide 7"></button>
                            <button type="button" data-bs-ta rget="#shopeeBanner" data-bs-slide-to="7"
                                aria-label="Slide 8"></button>
                            <button type="button" data-bs-target="#shopeeBanner" data-bs-slide-to="8"
                                aria-label="Slide 9"></button>
                        </div>
                        <div class="carousel-inner h-100">
                            <div class="carousel-item active">
                                <img src="{{ asset('assets/images/banner.jpg') }}" class="d-block w-100 rounded"
                                    alt="Banner 1">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/banner1.png') }}" class="d-block w-100 rounded"
                                    alt="Banner 2">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/banner3.jpg') }}" class="d-block w-100 rounded"
                                    alt="Banner 3">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/banner4.jpg') }}" class="d-block w-100 rounded"
                                    alt="Banner 4">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/banner5.jpg') }}" class="d-block w-100 rounded"
                                    alt="Banner 5">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/banner7.png') }}" class="d-block w-100 rounded"
                                    alt="Banner 6">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/banner8.jpg') }}" class="d-block w-100 rounded"
                                    alt="Banner 7">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/banner8.jpg') }}" class="d-block w-100 rounded"
                            ...
                            <div class="carousel-item">
                                <img src="{{ asset('assets/images/banner9.jpg') }}" class="d-block w-100 rounded"
                                    alt="Banner 9">
                            </div>
                        </div>
                        <button class="carousel-control-prev" type="button" data-bs-target="#shopeeBanner"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon"></span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#shopeeBanner"
                            data-bs-slide="next">
        ...
        <div class="bg-white rounded shadow p-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-10 gap-4">
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/thời trang nam.webp') }}" alt="Thời Trang Nam"
                ...
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/điện thoại.webp') }}" alt="Điện Thoại"
                            class="w-12 h-12 object-contain" />
                    </div>
                    <span class="text-xs text-center text-gray-700 group-hover:text-[#ee4d2d]">Điện Thoại & Phụ
                        Kiện</span>
                </div>
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/thiết bị điện tử.webp') }}" alt="Thiết Bị Điện Tử"
                            class="w-12 h-12 object-contain" />
                    </div>
                ...
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/máy tính và laptop.webp') }}" alt="Máy Tính & Laptop"
                            class="w-12 h-12 object-contain" />
                    </div>
                ...
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/máy ảnh và quay phim.webp') }}" alt="Máy Ảnh & Quay Phim"
                            class="w-12 h-12 object-contain" />
                    </div>
                    <span class="text-xs text-center text-gray-700 group-hover:text-[#ee4d2d]">Máy ảnh và quay
                        phim</span>
                </div>
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/đồng hồ.webp') }}" alt="Đồng Hồ"
                            class="w-12 h-12 object-contain" />
                    </div>
                ...
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/giaydepnam.webp') }}" alt="Giày Dép Nam"
                            class="w-12 h-12 object-contain" />
                    </div>
                ...
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/thietbigiadung.webp') }}" alt="Thiết Bị Gia Dụng"
                            class="w-12 h-12 object-contain" />
                    </div>
                    <span class="text-xs text-center text-gray-700 group-hover:text-[#ee4d2d]">Thiết bị đồ gia
                        dụng</span>
                </div>
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/thethaodulic.webp') }}" alt="Thể Thao & Du Lịch"
                            class="w-12 h-12 object-contain" />
                    </div>
                ...
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/otovaxedep.webp') }}" alt="Ô tô & Xe Máy"
                            class="w-12 h-12 object-contain" />
                    </div>
                    <span class="text-xs text-center text-gray-700 group-hover:text-[#ee4d2d]">Ô tô & xe máy & xe
                        đạp</span>
                </div>
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/voucher&dichvu.webp') }}" alt="Ô tô & Xe Máy"
                            class="w-12 h-12 object-contain" />
                    </div>
                ...
                <div class="flex flex-col items-center group cursor-pointer">
                    <div
                        class="w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-2 overflow-hidden border group-hover:shadow-lg transition">
                        <img src="{{ asset('assets/images/suckhoe.webp') }}" alt="Ô tô & Xe Máy"
                            class="w-12 h-12 object-contain" />
                    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                <div class="border rounded p-2 hover:shadow-lg transition">
                    <div class="relative">
                        ...
                        <div class="absolute top-0 right-0 bg-red-500 text-white text-xs px-1 py-0.5 rounded-bl">-50%
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                <div class="bg-white rounded shadow p-2 hover:shadow-lg transition">
                    <div class="relative">
                        ...
                        <div class="absolute top-0 right-0 bg-red-500 text-white text-xs px-1 py-0.5 rounded-bl">-20%
                        </div>
                    </div>
